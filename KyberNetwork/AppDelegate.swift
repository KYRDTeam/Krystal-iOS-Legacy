...
class AppDelegate: UIResponder, UIApplicationDelegate, UISplitViewControllerDelegate {
    ...
    func setLaunchScreen() {
        window?.rootViewController = SplashViewController.instantiateFromNib()
    ...
    func checkAppUpdate() {
        if VersionManager.shared.getCurrentVersionStatus() == .mustUpdate {
            let vc = ForceUpdateViewController.instantiateFromNib()
            vc.versionConfig = VersionManager.shared.getLatestVersionConfig()
