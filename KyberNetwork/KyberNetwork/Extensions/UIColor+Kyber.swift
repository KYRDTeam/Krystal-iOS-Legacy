...
extension UIColor {
  struct Kyber {
    ...
    static let pending = UIColor(red: 242, green: 190, blue: 55)
    ...
    static let buttonText = UIColor(hex: "010101")
    static let inactiveButtonText = UIColor(hex: "A9AEAD")
    static let popupBg = UIColor(hex: "292D2C")
