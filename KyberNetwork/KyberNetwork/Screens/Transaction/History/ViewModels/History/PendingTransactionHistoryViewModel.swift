...
class PendingTransactionHistoryViewModel: BaseTransactionHistoryViewModel {
  ...
  override init(currentWallet: KNWalletObject) {
    ...
    self.allTokens = EtherscanTransactionStorage.shared.getInternalHistoryTokenSymbols()
