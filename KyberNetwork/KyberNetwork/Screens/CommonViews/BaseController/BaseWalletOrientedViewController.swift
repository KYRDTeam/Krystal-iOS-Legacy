...
//class Base2WalletOrientedViewController: KNBaseViewController, Coordinator {
...
//}
//
//extension Base2WalletOrientedViewController { //}: WalletListV2ViewControllerDelegate {
//
