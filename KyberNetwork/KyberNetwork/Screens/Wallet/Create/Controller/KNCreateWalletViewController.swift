...
class KNCreateWalletViewController: KNBaseViewController {
  ...
  fileprivate func setupUI() {
    ...
    self.descLabel.text = "This will create a new wallet for you to transfer and receive token. Same wallet can be on both chains Ethereum, Binance Smart Chain, Polygon and Avalanche."
