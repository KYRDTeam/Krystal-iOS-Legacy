...
class KNCreateWalletViewController: KNBaseViewController {
  ...
  fileprivate func setupUI() {
    ...
    self.descLabel.text = "This will create a new wallet for you to transfer and receive tokens. The same wallet can be used on ETH, BSC, Polygon(Matic), Avalanche, Fantom and Cronos."
