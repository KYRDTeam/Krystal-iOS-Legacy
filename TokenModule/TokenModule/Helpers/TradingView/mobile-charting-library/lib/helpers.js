...
function _makeApiRequest() {
  _makeApiRequest = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee(apiURL, path) {
    var response;
      ...
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            _context.prev = 0;
            _context.next = 3;
            return fetch("".concat(apiURL, "/").concat(path));
          ...
          case 7:
            ...
            throw new Error("Krystal request error: ".concat(_context.t0.status));
