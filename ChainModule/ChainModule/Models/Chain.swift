...
public class Chain {
    ...
    public init(id: Int, name: String, type: String, iconUrl: String, isActive: Bool, isDefault: Bool, isAddedByUser: Bool, smartContracts: [ChainSmartContract] = [], urls: [ChainUrl] = [], configs: [ChainConfig] = []) {
        self.id = id
        self.name = name
        self.type = type
