...
class SwapV2PlatformCell: UITableViewCell {
    ...
    func configure(viewModel: SwapPlatformItemViewModel) {
        ...
        overlayView.kn_borderColor = viewModel.isSelected ? AppTheme.current.primaryColor : .clear
        overlayView.kn_borderWidth = viewModel.isSelected ? 1 : 0
        overlayView.backgroundColor = viewModel.isSelected ? AppTheme.current.primaryColor.withAlphaComponent(0.1) : .clear
