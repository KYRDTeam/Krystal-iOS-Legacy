...
struct RPCConfig {
    ...
    var rpcURL: URL {
        let urlString: String = {
            switch server {
            case .main: return "https://mainnet.infura.io/v3/" + NodeConfig.infuraKey
            case .classic: return "https://web3.gastracker.io"
            case .callisto: return "https://rpc.callisto.network"
            case .kovan: return "https://kovan.infura.io/v3/" + NodeConfig.infuraKey
            case .ropsten: return "https://ropsten.infura.io/v3/" + NodeConfig.infuraKey
            case .rinkeby: return "https://rinkeby.infura.io/v3/" + NodeConfig.infuraKey
